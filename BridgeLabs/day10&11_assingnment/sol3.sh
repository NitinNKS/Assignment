...
Tails - Use ((RANDOM)) to find Heads or Tails

uc -2 : As a simulator, loop through Multiple times of flipping a 
coin store the Singlet Combination in a Dictionary.
Finally determine the percentage of the Singlet
Combination. - Singlet shows Heads or Tails

uc -3 : As a simulator, loop to create a Doublet
Combination. Store the doublet combination as
well as the percentage. - Doublet Combinations are HH, HT, TH, and TT

uc -4 : As a simulator, do the same for Triplet
Combination.

uc -5 : As a simulator, sort the Singlet, Doublet and
